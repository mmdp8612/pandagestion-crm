...
@section('content')
    <div class="max-w-4xl">
        <div>
            ...
            <h1 class="mt-2 text-3xl font-bold tracking-tight text-slate-950">Nuevo rol</h1>
            <p class="mt-2 text-sm leading-6 text-slate-600">
                Definí un nombre y seleccioná los módulos a los que podrán acceder los usuarios con este rol.
            </p>
        </div>

        <form method="POST" action="{{ route('admin.roles.store') }}" class="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            @csrf
