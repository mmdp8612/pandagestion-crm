...
@section('content')
    <div class="max-w-5xl">
        <div>
            ...
            <h1 class="mt-2 text-3xl font-bold tracking-tight text-slate-950">Editar propiedad</h1>
            <p class="mt-2 text-sm leading-6 text-slate-600">Actualizá la identificación, clasificación, características, comercialización, ubicación, multimedia y publicación de {{ $property->Codigo }}.</p>
        </div>
        ...
        <form
            ...
            data-confirm
            data-confirm-when="#regenerar_slug"
            data-confirm-title="¿Regenerar el slug?"
            data-confirm-text="La futura URL pública de la propiedad cambiará."
            data-confirm-button="Sí, regenerar y guardar"
