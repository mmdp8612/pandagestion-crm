...
class StoreCommercializationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'id' => [
                ...
                'max:3',
                'regex:/^[A-Z0-9-]+$/',
                Rule::unique('tip_comercializacion', 'IdComercializacion'),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'id.unique' => 'Ya existe una comercialización con ese código.',
            'descripcion.required' => 'La descripción es obligatoria.',
            'descripcion.max' => 'La descripción no puede superar los 15 caracteres.',
            'hab.required' => 'Indicá si la comercialización está habilitada.',
